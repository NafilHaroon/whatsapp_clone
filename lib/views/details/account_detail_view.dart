  ...
  Widget build(BuildContext context) {
    final _themeData = Theme.of(context).copyWith(
      textTheme: context.style.copyWith(
          bodyLarge: const TextStyle(fontSize: 16, color: kPureBlack),
            ...
            child: ListTileTheme(
              ...
              child: SliverList(
                ...
                [
                  ...
                  Column(
                    children: [
                      const ListTile(title: Text('Custom notifications')),
                      _buildDivider(),
                      const ListTile(title: Text('Media Visiblity')),
                      _buildDivider(),
                      _spacer,
                      const ListTile(
                        ...
                        title: Column(
                          ...
                          children: [
                            Text('About and phone number',
                                style: context.style.bodySmall),
                            _spacer,
                            const Text('Will be on the rising phase',
                                maxLines: 2, overflow: TextOverflow.ellipsis),
                          ],
                        ),
                        subtitle: const Text('March 7'),
                      ),
                      ListTile(
                        title: const Text('+923338275558'),
                        ...
                        ListView.builder(
                            ...
                            itemBuilder: (_, index) {
                              ...
                              return ListTile(
                                  ...
                                  title: const Text('Pakistan Zindabad'));
                            }),
                      ],
                    ),
                  ),
